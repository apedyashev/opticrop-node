...
var GAMMA, async, getPixels, gm, utils;
...
exports.Opticrop = (function() {
  function Opticrop() {
    this._cachePath = '/tmp/ocrop/';
  }
        ...
        'size', 'createEdgedImage', (function(_this) {
          return function(cb, results) {
            return getPixels(results.createEdgedImage.resultFile, function(err, pixels) {
              var area, beta, betanorm, c, currfile, h0, hcrop, hcrop0, hgap, hinc, i, j, k, maxbetanorm, maxfile, maxparam, n, nk, sum, targetAspectRatio, val, w0, wcrop, wcrop0, wgap, winc, xcenter, xcrop, ycenter, ycrop, _i, _j, _k, _ref, _ref1;
              if (err) {
              ...
              for (k = _j = 0; 0 <= nk ? _j < nk : _j > nk; k = 0 <= nk ? ++_j : --_j) {
                ...
                currfile = "" + this._cachePath + "image" + k + ".jpg";
                beta = 0;
